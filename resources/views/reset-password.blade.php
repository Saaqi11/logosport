    ...
    <header class="main-header">
        <div class="container">
            <div class="row">
                ...
                <div
                    class="offset-lg-5 col-lg-5 offset-md-3 col-md-6 col-sm-8 d-flex justify-content-end align-items-center">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col offset-lg-3 col-lg-6">
                    <div class="wrp-rgsin wrp-rgsin__3">
                        <form id="forget-password" action="{{ route('user.doResetPassword') }}" class="rgsin-form" method="POST">
                            @csrf
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <input type="hidden" name="email" placeholder="Email adress*"
                                            value="{{ $email }}" required>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <span class="input-text">Code*</span>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
                                        <button class="btn-start">Confirm</button>
                                    </div>
                                </div>
                            </div>
                        </form>
