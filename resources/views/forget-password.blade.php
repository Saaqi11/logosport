        ...
        <div class="row">
            <div class="col offset-lg-3 col-lg-6">
                <div class="wrp-rgsin wrp-rgsin__3">
                    <form id="forget-password" action="{{ route("user.doforgetPassword") }}" class="rgsin-form" method="POST">
                        @csrf
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <input type="email" name="email" placeholder="Email adress*" value="" required>
                                    </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center">
                                        <button class="btn-start">Send Link</button>
                                </div>
                            </div>
                        </div>
                    </form>
